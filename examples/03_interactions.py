...
viewer = ModelViewer(
    src=src, alt="Click me", camera_controls=True, height=400, sizing_mode="stretch_width"
)
...
pn.template.FastListTemplate(
    ...
    main=[pn.pane.Markdown("## Click on the 3D model to see events below"), viewer, logger],
).servable()
